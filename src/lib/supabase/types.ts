  ...
  public: {
    Tables: {
      supports: {
        ...
        Insert: Omit<Database["public"]["Tables"]["supports"]["Row"], "id" | "created_at" | "updated_at" | "is_active" | "source" | "raw_eligibility_text" | "raw_exclusion_text" | "raw_preference_text" | "extraction_confidence" | "external_id" | "target_founder_age_min" | "target_founder_age_max" | "service_type" | "target_age_min" | "target_age_max" | "target_household_types" | "target_income_levels" | "target_employment_status" | "benefit_categories"> & {
          id?: string
          created_at?: string
          updated_at?: string
          is_active?: boolean
      ...
      diagnoses: {
        ...
        Insert: Omit<Database["public"]["Tables"]["diagnoses"]["Row"], "id" | "created_at" | "matched_count" | "matched_scores" | "business_start_date" | "user_type" | "age_group" | "gender" | "household_type" | "income_level" | "employment_status" | "interest_categories"> & {
          id?: string
          created_at?: string
          matched_count?: number
          matched_scores?: MatchedScoreJson[] | null
